...
app.post('/images',(req,res)=>{
    if(itemData['Data'][req.body.image]!=undefined || itemData['Data'][req.body.image].image!=undefined) res.send(JSON.stringify({extension:itemData['Data'][req.body.image].image.replace("\"","").split(".")[1]}))
